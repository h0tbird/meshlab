...
```console
step certificate inspect --bundle --servername istiod-1-18-2.istio-system.svc https://192.168.64.3:15012 --roots /path/to/root-ca.pem
step certificate inspect --bundle --servername istiod-1-18-2.istio-system.svc https://192.168.64.3:15012 --insecure
```
