...
declare -A DEPS=(
  ...
  [install-gateway-api]="setup-kubeconfig"
  ...
  [install-applicationsets]="register-argocd-clusters install-gateway-api"
  [setup-argowf]="setup-kubeconfig"
  [kiali-secrets]="setup-kubeconfig"
  [bootstrap-dag]="install-applicationsets setup-argowf kiali-secrets"
